...
import { TermsAndPolicies, TermsAndPoliciesProps } from "src/core";
import { getProps } from "utils";

const TermsAndPoliciesPage: NextPage<TermsAndPoliciesProps> = (props) => {
  return <TermsAndPolicies {...props} />;
};
