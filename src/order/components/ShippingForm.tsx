  ...
  return (
    <List sx={{ width: "100%" }}>
      {props.options?.map((option, index) => (
        ...
        >
          <ListItemButton disableGutters disableRipple sx={{ padding: '16px', wordBreak: 'break-all' }}>
            <ListItemIcon>
              <Radio
            ...
            <ListItemText
              ...
              secondaryTypographyProps={{ color: 'grey.400', variant: 'h5', lineHeight: '23px', whiteSpace: 'pre-wrap', maxWidth: '500px' }}
            />
            <Typography variant="h4" pr="16px" minWidth="95px" textAlign="right">
              <Typography component="span" fontFamily="Roboto">
                ฿
              </Typography>
              {intl.formatNumber(
                getShipmentPrice(option, props.cartItems),
                {
