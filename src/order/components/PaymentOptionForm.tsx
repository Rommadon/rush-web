...
import { MerchantShopditPaymentMethodModel } from "../models";
                    ...
                    onClick={
                      () => {
                        props.setValue('invoiceAttributes', {
                          ...props?.currentInvoiceAttributes,
                          paymentMethodType: 'shopditpayCreditCard',
                          merchantShopditPaymentMethodId: props.merchantShopditPaymentMethods[0].id,
                          merchantBankAccountPaymentMethodId: undefined,
                          merchantPromptpayPaymentMethodId: undefined,
                          merchantCashPaymentMethodId: undefined,
                        });
                      }
                    }
                  />
