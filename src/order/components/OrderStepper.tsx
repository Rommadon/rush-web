...
import { Stepper, Step, StepLabel, Box, Typography, useMediaQuery } from "@mui/material";
...
export const OrderStepper: FC<OrderStepperProps> = (props) => {
  ...
  return props.status !== "cancel" && props.status !== "expire" ? (
    <Box width="100%" overflow="scroll">
      <Stepper
        sx={{ mt: "40px", minWidth: "500px", padding: 0 }}
